...
function termos() {
  return (
    <article>
      ...
      <p>
        <span>
          Ao acessar ao site <a href="https://assuntos.dev">Assuntos.dev</a>,
      ...
      <p>
        <span>
          ...
          materiais (informações ou software) no site Assuntos.dev , apenas para
      ...
      <p>
        <span>
          ...
          dessas restrições e poderá ser rescindida por Assuntos.dev a qualquer
      ...
      <ol>
        <li>
          <span>
            Os materiais no site da Assuntos.dev são fornecidos 'como estão'.
            Assuntos.dev não oferece garantias, expressas ou implícitas, e, por
        ...
        <li>
          <span>
            Além disso, o Assuntos.dev não garante ou faz qualquer representação
      ...
      <p>
        <span>
          Em nenhum caso o Assuntos.dev ou seus fornecedores serão responsáveis
          ...
          uso ou da incapacidade de usar os materiais em Assuntos.dev, mesmo que
          Assuntos.dev ou um representante autorizado da Assuntos.dev tenha sido
      ...
      <p>
        <span>
          Os materiais exibidos no site da Assuntos.dev podem incluir erros
          técnicos, tipográficos ou fotográficos. Assuntos.dev não garante que
          qualquer material em seu site seja preciso, completo ou atual.
          Assuntos.dev pode fazer alterações nos materiais contidos em seu site
          a qualquer momento, sem aviso prévio. No entanto, Assuntos.dev não se
      ...
      <p>
        <span>
          O Assuntos.dev não analisou todos os sites vinculados ao seu site e
          não é responsável pelo conteúdo de nenhum site vinculado. A inclusão
          de qualquer link não implica endosso por Assuntos.dev do site. O uso
      ...
      <p>
        <span>
          O Assuntos.dev pode revisar estes termos de serviço do site a qualquer
      ...
      <p>
        <span>
          ...
          leis do Assuntos.dev e você se submete irrevogavelmente à jurisdição
