...
export default function Footer() {
  return (
    <footer className="bg-dark flex flex-col justify-between p-6 text-sm mt-16 w-auto h-80">
      <p className="text-light selection:bg-light selection:text-dark">Feito por <a target='adeir' className="underline hover:opacity-70" href="https://adeir.me">Adeir Junior</a></p>
