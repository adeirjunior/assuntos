export const sanityConfig = {
  ...
  dataset: process.env.NODE_ENV === process.env.SANITY_PRIVATE_DATASET ? process.env.SANITY_PRIVATE_DATASET : 
  process.env.SANITY_PUBLIC_DATASET,
  projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID,
  useCdn:
    typeof document !== 'undefined' && process.env.NODE_ENV === process.env.SANITY_PUBLIC_DATASET,
